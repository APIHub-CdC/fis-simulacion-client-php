...
class DomicilioPeticion implements ModelInterface, ArrayAccess
{
    ...
    protected static $fisTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\FIS\Simulacion\MX\Client\Model\CatalogoEstados',
        'cp' => 'string',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => '\FIS\Simulacion\MX\Client\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => '\FIS\Simulacion\MX\Client\Model\CatalogoTipoAsentamiento'
    ];
