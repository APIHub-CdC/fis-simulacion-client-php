...
class PersonaPeticion implements ModelInterface, ArrayAccess
{
    ...
    protected static $fisTypes = [
        ...
        'rfc' => 'string',
        'curp' => 'string',
        'nacionalidad' => '\FIS\Simulacion\MX\Client\Model\CatalogoNacionalidad',
        'residencia' => '\FIS\Simulacion\MX\Client\Model\CatalogoResidencia',
        'estado_civil' => '\FIS\Simulacion\MX\Client\Model\CatalogoEstadoCivil',
        'sexo' => '\FIS\Simulacion\MX\Client\Model\CatalogoSexo',
        'clave_elector_ife' => 'string',
        'numero_dependientes' => 'int',
        'fecha_defuncion' => 'string',
        'domicilio' => '\FIS\Simulacion\MX\Client\Model\DomicilioPeticion'
    ];
